...
-- Target name
FontStyleBig = {"Interface\\AddOns\\oUF_Banaak\\fonts\\din1451e.ttf", 40, "THICKOUTLINE"},
-- Power, absolute health
FontStyleMedium = {"Interface\\AddOns\\oUF_Banaak\\fonts\\din1451e.ttf", 16},
-- ToT, TToT, pet
FontStyleSmall = {"Interface\\AddOns\\oUF_Banaak\\fonts\\din1451e.ttf", 14},
-- Castbar: Time text, focus spell name
CastBarBig = {"Interface\\AddOns\\oUF_Banaak\\fonts\\tahoma.ttf", 15},
-- Castbar: Spell name (player, target)
CastBarMedium = {"Interface\\AddOns\\oUF_Banaak\\fonts\\tahoma.ttf", 9},
-- Castbar: Latency
CastBarSmall = {"Interface\\AddOns\\oUF_Banaak\\fonts\\tahoma.ttf", 8},
...
CastbarIcon = true,
-- Bar fill texture
CastbarTexture = "Interface\\AddOns\\oUF_Banaak\\textures\\flat.blp",
-- Border texture
CastbarBorderTexture = "Interface\\AddOns\\oUF_Banaak\\textures\\2px_glow.blp",
-- Background and latency texture
CastbarBackdropTexture = "Interface\\AddOns\\oUF_Banaak\\textures\\flat.blp",
...
AuraBorder = "Interface\\AddOns\\oUF_Banaak\\textures\\borders\\dark_2.blp",
