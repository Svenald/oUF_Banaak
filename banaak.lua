...
oUF_Banaak.classResources = {
	['PALADIN'] = {
		inactive = {'Interface\\AddOns\\oUF_Banaak\\textures\\HolyPower.blp', { 0, 18/64, 0, 18/32 }},
		active = {'Interface\\AddOns\\oUF_Banaak\\textures\\HolyPower.blp', { 18/64, 36/64, 0, 18/32 }},
		size = {18, 18},
		max = 5,
	},
	['MONK'] = {
	...
	['SHAMAN'] = {
		inactive = {'Interface\\AddOns\\oUF_Banaak\\textures\\blank.blp', { 0, 23/128, 0, 20/32 }},
		active = {'Interface\\AddOns\\oUF_Banaak\\textures\\totems.blp', { (1+23)/128, ((23*2)+1)/128, 0, 20/32 }},
		size = {23, 20},
		spacing = -3,
		inverse = true,
		max = 3,
	...
	['WARLOCK'] = {
		inactive = {'Interface\\AddOns\\oUF_Banaak\\textures\\shard_bg.blp'},
		active = {'Interface\\AddOns\\oUF_Banaak\\textures\\shard.blp'},
		size = {16, 16},
		spacing = 5,
		max = 6,
	}
...
fntBig:SetFont("Interface\\AddOns\\oUF_Banaak\\fonts\\din1451e.ttf", 14, "OUTLINE")
--fntBig:SetFont(unpack(cfg.FontStyleBig))
local fntMedium = CreateFont("UFFontMedium")
fntMedium:SetFont("Interface\\AddOns\\oUF_Banaak\\fonts\\din1451e.ttf", 12, "OUTLINE")
...
fntSmall:SetFont("Interface\\AddOns\\oUF_Banaak\\fonts\\tahoma.ttf", 10, "OUTLINE")
...
oUF_Banaak.AdjustMirrorBars = function()
...
oUF_Banaak.UpdateDispel = function()
	canDispel = {
		["DEMONHUNTER"] = {},
		["DEATHKNIGHT"] = {},
...
oUF_Banaak.UpdateHealth = function(self)
	...
	if not status then
		...
		if self.unit:find("boss") then
			self.health[1]:SetSize(oUF_Banaak.digitTexCoords["B"][2], oUF_Banaak.digitTexCoords["height"])
			self.health[1]:SetTexCoord(oUF_Banaak.digitTexCoords["B"][1] / oUF_Banaak.digitTexCoords["texWidth"], (oUF_Banaak.digitTexCoords["B"][1] + oUF_Banaak.digitTexCoords["B"][2]) / oUF_Banaak.digitTexCoords["texWidth"], 1 / oUF_Banaak.digitTexCoords["texHeight"], (1 + oUF_Banaak.digitTexCoords["height"]) / oUF_Banaak.digitTexCoords["texHeight"])
			self.health[1]:Show()
			self.healthFill[1]:SetSize(oUF_Banaak.digitTexCoords["B"][2], oUF_Banaak.digitTexCoords["height"] * h / hMax)
			self.healthFill[1]:SetTexCoord(
				oUF_Banaak.digitTexCoords["B"][1] / oUF_Banaak.digitTexCoords["texWidth"],
				(oUF_Banaak.digitTexCoords["B"][1] + oUF_Banaak.digitTexCoords["B"][2]) / oUF_Banaak.digitTexCoords["texWidth"],
				(2 + 2 * oUF_Banaak.digitTexCoords["height"] - oUF_Banaak.digitTexCoords["height"] * h / hMax) / oUF_Banaak.digitTexCoords["texHeight"],
				(2 + 2 * oUF_Banaak.digitTexCoords["height"]) / oUF_Banaak.digitTexCoords["texHeight"]
			)
			...
			for i = 1, 4 do
				if i > len then
					...
					self.health[5 - i]:SetSize(oUF_Banaak.digitTexCoords[digit][2], oUF_Banaak.digitTexCoords["height"])
					self.health[5 - i]:SetTexCoord(oUF_Banaak.digitTexCoords[digit][1] / oUF_Banaak.digitTexCoords["texWidth"], (oUF_Banaak.digitTexCoords[digit][1] + oUF_Banaak.digitTexCoords[digit][2]) / oUF_Banaak.digitTexCoords["texWidth"], 1 / oUF_Banaak.digitTexCoords["texHeight"], (1 + oUF_Banaak.digitTexCoords["height"]) / oUF_Banaak.digitTexCoords["texHeight"])
					self.health[5 - i]:Show()
					self.healthFill[5 - i]:SetSize(oUF_Banaak.digitTexCoords[digit][2], oUF_Banaak.digitTexCoords["height"] * h / hMax)
					self.healthFill[5 - i]:SetTexCoord(oUF_Banaak.digitTexCoords[digit][1] / oUF_Banaak.digitTexCoords["texWidth"], (oUF_Banaak.digitTexCoords[digit][1] + oUF_Banaak.digitTexCoords[digit][2]) / oUF_Banaak.digitTexCoords["texWidth"], (2 + 2 * oUF_Banaak.digitTexCoords["height"] - oUF_Banaak.digitTexCoords["height"] * h / hMax) / oUF_Banaak.digitTexCoords["texHeight"], (2 + 2 * oUF_Banaak.digitTexCoords["height"]) / oUF_Banaak.digitTexCoords["texHeight"])
		...
		if self.unit:find("boss") then
			...
			self.health[1]:SetSize(oUF_Banaak.digitTexCoords[status][2], oUF_Banaak.digitTexCoords["height"])
			self.health[1]:SetTexCoord(oUF_Banaak.digitTexCoords[status][1] / oUF_Banaak.digitTexCoords["texWidth"], (oUF_Banaak.digitTexCoords[status][1] + oUF_Banaak.digitTexCoords[status][2]) / oUF_Banaak.digitTexCoords["texWidth"], 1 / oUF_Banaak.digitTexCoords["texHeight"], (1 + oUF_Banaak.digitTexCoords["height"]) / oUF_Banaak.digitTexCoords["texHeight"])
			self.health[1]:Show()
		else
			for i = 1, 4 do
			...
			self.health[4]:SetSize(oUF_Banaak.digitTexCoords[status][2], oUF_Banaak.digitTexCoords["height"])
			self.health[4]:SetTexCoord(oUF_Banaak.digitTexCoords[status][1] / oUF_Banaak.digitTexCoords["texWidth"], (oUF_Banaak.digitTexCoords[status][1] + oUF_Banaak.digitTexCoords[status][2]) / oUF_Banaak.digitTexCoords["texWidth"], 1 / oUF_Banaak.digitTexCoords["texHeight"], (1 + oUF_Banaak.digitTexCoords["height"]) / oUF_Banaak.digitTexCoords["texHeight"])
			self.health[4]:Show()
...
oUF_Banaak.UpdateStatus = function(self)
...
oUF_Banaak.PostUpdateName = function(self)
	if (self.name) then
...
-- Sticky aura colors
oUF_Banaak.PostUpdateIcon = function(self, button, unit, data, position)
	local icon = button.Icon
	local filter = button.isHarmful and "HARMFUL" or "HELPFUL"
	...
	if filter == "HELPFUL" and not UnitCanAttack("player", unit) and caster == "player" and cfg["Auras" .. upper(unit)].StickyAuras.myBuffs then
		-- Sticky aura: myBuffs
		icon:SetVertexColor(unpack(cfg.AuraStickyColor))
		icon:SetDesaturated(false)
	elseif filter == "HARMFUL" and UnitCanAttack("player", unit) and caster == "player" and cfg["Auras" .. upper(unit)].StickyAuras.myDebuffs then
		-- Sticky aura: myDebuffs
		icon:SetVertexColor(unpack(cfg.AuraStickyColor))
		icon:SetDesaturated(false)
	elseif filter == "HARMFUL" and UnitCanAttack("player", unit) and caster == "pet" and cfg["Auras" .. upper(unit)].StickyAuras.petDebuffs then
		-- Sticky aura: petDebuffs
		icon:SetVertexColor(unpack(cfg.AuraStickyColor))
		icon:SetDesaturated(false)
	elseif filter == "HARMFUL" and not UnitCanAttack("player", unit) and canDispel[({UnitClass("player")})[2]][dtype] and cfg["Auras" .. upper(unit)].StickyAuras.curableDebuffs then
		-- Sticky aura: curableDebuffs
		icon:SetVertexColor(DebuffTypeColor[dtype].r, DebuffTypeColor[dtype].g, DebuffTypeColor[dtype].b)
		icon:SetDesaturated(false)
	elseif filter == "HELPFUL" and UnitCanAttack("player", unit) and UnitIsUnit(unit, caster or "") and cfg["Auras" .. upper(unit)].StickyAuras.enemySelfBuffs then
...
oUF_Banaak.customAuraFilter = function(auras, unit, data)
	local caster = data.sourceUnit
	if caster == "vehicle" then caster = "player" end
	if auras.filter == "HELPFUL" and not UnitCanAttack("player", unit) and caster == "player" and cfg["Auras" .. upper(unit)].StickyAuras.myBuffs then
		-- Sticky aura: myBuffs
		return true
	elseif auras.filter == "HARMFUL" and UnitCanAttack("player", unit) and caster == "player" and cfg["Auras" .. upper(unit)].StickyAuras.myDebuffs then
		-- Sticky aura: myDebuffs
		return true
	elseif auras.filter == "HARMFUL" and UnitCanAttack("player", unit) and caster == "pet" and cfg["Auras" .. upper(unit)].StickyAuras.petDebuffs then
		-- Sticky aura: petDebuffs
		return true
	elseif auras.filter == "HARMFUL" and not UnitCanAttack("player", unit) and canDispel[({UnitClass("player")})[2]][data.dispelName] and cfg["Auras" .. upper(unit)].StickyAuras.curableDebuffs then
		-- Sticky aura: curableDebuffs
		return true
	-- Usage of UnitIsUnit: Call from within focus frame will return "target" as caster if focus is targeted (player > target > focus)
	elseif auras.filter == "HELPFUL" and UnitCanAttack("player", unit) and UnitIsUnit(unit, caster or "") and cfg["Auras" .. upper(unit)].StickyAuras.enemySelfBuffs then
		-- Sticky aura: enemySelfBuffs
		return true
	else
		-- Aura is not sticky, filter is set to blacklist
		if cfg["Auras" .. upper(unit)].FilterMethod[auras.filter == "HELPFUL" and "Buffs" or "Debuffs"] == "BLACKLIST" then
		...
		elseif cfg["Auras" .. upper(unit)].FilterMethod[auras.filter == "HELPFUL" and "Buffs" or "Debuffs"] == "WHITELIST" then
...
-- Aura mouseover
oUF_Banaak.OnEnterAura = function(self, icon)
	-- Aura magnification
...
-- Aura mouseout
oUF_Banaak.OnLeaveAura = function(self)
	self.HighlightAura:Hide()
end

-- Hook aura scripts, set aura border
oUF_Banaak.PostCreateButton = function(icons, icon)
	...
	icon:HookScript("OnEnter", function() oUF_Banaak.OnEnterAura(icons:GetParent(), icon) end)
	icon:HookScript("OnLeave", function() oUF_Banaak.OnLeaveAura(icons:GetParent()) end)
	...
	icon:HookScript("OnClick", function(_, button, down)
		if button == "RightButton" and down == false then
			if icon.filter == "HELPFUL" and UnitIsUnit("player", icons:GetParent().unit) then
				...
				oUF_Banaak.OnLeaveAura(icons:GetParent())
			end
		end
	end)
end
...
-- Debuff anchoring
oUF_Banaak.PostBuffUpdate = function(buffs, unit)
...
-- Castbar
oUF_Banaak.PostCastStart = function(castbar, unit, name, rank, castid)
...
oUF_Banaak.PostChannelStart = function(castbar, unit, name, rank)
...
-- Castbar animations
oUF_Banaak.PostCastSucceeded = function(castbar, spell)
...
oUF_Banaak.PostCastStop = function(castbar, unit, spellname, spellrank, castid)
...
oUF_Banaak.PostChannelStop = function(castbar, unit, spellname, spellrank)
...
oUF_Banaak.PostSpawnFrames = function(this)
	-- custom_modifications function
	oUF_Banaak.UpdateDispel()
end

-- Frame constructor -----------------------------

oUF_Banaak.sharedStyle = function(self, unit, isSingle)
	self.menu = oUF_Banaak.menu
	...
	if unit == "player" then self:RegisterEvent("ACTIVE_TALENT_GROUP_CHANGED", oUF_Banaak.UpdateDispel, true) end
	if unit == "player" then self:RegisterEvent("ACTIVE_TALENT_GROUP_CHANGED", oUF_Banaak.UpdateStatus, true) end
	...
	if unit == "player" or unit == "target" or unit == "focus" or unit:find("boss") then
		...
		tinsert(self.__elements, oUF_Banaak.UpdateHealth)

		for i = unit:find("boss") and 1 or 4, 1, -1 do
			health[i] = self:CreateTexture(nil, "ARTWORK")
			health[i]:SetTexture("Interface\\AddOns\\oUF_Banaak\\textures\\digits.blp")
			health[i]:Hide()
			healthFill[i] = self:CreateTexture(nil, "OVERLAY")
			healthFill[i]:SetTexture("Interface\\AddOns\\oUF_Banaak\\textures\\digits.blp")
	...
	if unit == "player" then
		...
		for i, icon in ipairs({
			...
			if match(cfg.StatusIcons, icon[1]) then
				...
				self[icon[2]]:SetTexture("Interface\\AddOns\\oUF_Banaak\\textures\\statusicons.blp")
				self[icon[2]]:SetTexCoord((i - 1) * 24 / 256, i * 24 / 256, 0, 24 / 32)
				self[icon[2]].Override = oUF_Banaak.UpdateStatus
			end
	...
	if unit == "player" then
		...
		self.RaidTargetIndicator:SetTexture("Interface\\AddOns\\oUF_Banaak\\textures\\raidicons.blp")
	...
	elseif unit == "target" or unit == "focus" then
		...
		tinsert(self.__elements, oUF_Banaak.PostUpdateName)
		self:RegisterEvent("PLAYER_FLAGS_CHANGED", function(_, _, unit)
			if unit == self.unit then
				oUF_Banaak.PostUpdateName(unit)
			end
		end)
	elseif unit:find("boss") then
	...
	if unit == "player" and cfg.ShowXP then
		...
		raidIconDummy:SetTexture("Interface\\AddOns\\oUF_Banaak\\textures\\raidicons.blp")
	...
	if unit == "player" and (playerClass == "ROGUE" or playerClass == "DRUID") then
		...
		for i = 1, maxComboPoints do
			...
			bg[i]:SetTexture("Interface\\AddOns\\oUF_Banaak\\textures\\combo.blp")
			bg[i]:SetTexCoord(0, 16 / 64, 0, 1)
			bg[i]:SetAllPoints(self.CPoints[i])
			fill[i] = self.CPoints[i]:CreateTexture(nil, "OVERLAY")
			fill[i]:SetTexture("Interface\\AddOns\\oUF_Banaak\\textures\\combo.blp")
		...
		self:RegisterEvent("UNIT_POWER_UPDATE", function(self, event, unit)
			if unit == "player" then
				local cp = UnitPower("player", Enum.PowerType.ComboPoints)
				for i = 1, maxComboPoints do
					if self.CPoints[i] then
						if i <= cp then
							self.CPoints[i]:Show()
						else
							self.CPoints[i]:Hide()
	...
	if unit == "player" and playerClass == "DEATHKNIGHT" then
		...
		for i = 1, 6 do
			...
			self.Runes[i]:SetStatusBarTexture("Interface\\AddOns\\oUF_Banaak\\textures\\blank.blp")
			...
			backdrop:SetTexture("Interface\\AddOns\\oUF_Banaak\\textures\\combo.blp")
			...
			self.Runes[i].bg:SetTexture("Interface\\AddOns\\oUF_Banaak\\textures\\combo.blp")
	...
	if unit == "player" and showTotemBar then
		...
		initClassSingleIcon = function(unitFrame, i, icon)
			local data = oUF_Banaak.classResources[playerClass]
	...
	if unit == "player" and showTotemBar then
		...
		for i = 1, oUF_Banaak.classResources[playerClass].max do
	...
	if unit == "target" or unit == "focus" or (cfg.PlayerBuffs and unit == "player") then
		...
		self.Buffs.PostUpdateIcon = oUF_Banaak.PostUpdateIcon
		self.Debuffs.PostUpdateIcon = oUF_Banaak.PostUpdateIcon
		self.Buffs.PostCreateButton = oUF_Banaak.PostCreateButton
		self.Debuffs.PostCreateButton = oUF_Banaak.PostCreateButton
		self.Buffs.PostUpdate = oUF_Banaak.PostBuffUpdate
		self.Buffs.FilterAura = oUF_Banaak.customAuraFilter
		self.Debuffs.FilterAura = oUF_Banaak.customAuraFilter
	end
	...
	if cfg.Castbar and (unit == "player" or unit == "target" or unit == "focus") then
		...
		self:RegisterEvent("UNIT_SPELLCAST_SUCCEEDED", function(_, _, unit, spell, rank)
			if UnitIsUnit(unit, self.unit) and not cb.castIsChanneled then
				oUF_Banaak.PostCastSucceeded(cb, spell)
			end
		end)
		...
		cb.PostCastStart = oUF_Banaak.PostCastStart
		cb.PostChannelStart = oUF_Banaak.PostChannelStart
		cb.PostCastStop = oUF_Banaak.PostCastStop
		cb.PostChannelStop = oUF_Banaak.PostChannelStop
...
for modName, modHooks in pairs(oUF_Banaak_hooks) do
	...
	for k, v in pairs(modHooks) do
		numHooks = numHooks + 1
		local success, ret = pcall(hooksecurefunc, oUF_Banaak, k, v)
		if not success then
			modErr = true
			DEFAULT_CHAT_FRAME:AddMessage("oUF_Banaak: Couldn't create hook for function " .. k .. "() in |cFFFF5033" .. modName .. "|r: \"" .. ret .. "\"", cfg.colors.text[1], cfg.colors.text[2], cfg.colors.text[3])
		end
	end
...
if modList then
	DEFAULT_CHAT_FRAME:AddMessage("oUF_Banaak: Applied custom modifications: " .. strsub(modList, 1, -3), cfg.colors.text[1], cfg.colors.text[2], cfg.colors.text[3])
	modList = nil
end

-- Frame creation --------------------------------

oUF:RegisterStyle("Banaak", oUF_Banaak.sharedStyle)
oUF:SetActiveStyle("Banaak")
...
if cfg.Castbar then oUF_Banaak.AdjustMirrorBars() end

if cfg.RangeFade and not IsAddOnLoaded("oUF_SpellRange") then
	DEFAULT_CHAT_FRAME:AddMessage("oUF_Banaak: Please download and install oUF_SpellRange before enabling range checks!", cfg.colors.text[1], cfg.colors.text[2], cfg.colors.text[3])
elseif cfg.TotemBar and not IsAddOnLoaded("oUF_TotemBar") then
	DEFAULT_CHAT_FRAME:AddMessage("oUF_Banaak: Please download and install oUF_TotemBar before enabling the totem bar!", cfg.colors.text[1], cfg.colors.text[2], cfg.colors.text[3])
end

-- Call for custom_modifications
oUF_Banaak.PostSpawnFrames(oUF_Banaak)
end)